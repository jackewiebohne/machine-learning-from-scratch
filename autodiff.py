# This is a simple graph-based autodifferentiation programme. It integrates and derives. Integration is less complete in most cases than derivation. 
# Current methods are analytic. 
